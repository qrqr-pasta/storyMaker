...
# 物語要素データ
STORY_ELEMENTS = {
    "layer1A": ["タイムループ", "記憶喪失", "異世界転生", "デスゲーム", "正体隠蔽", "入れ替わり", "予言・運命", "魂の契約", "能力覚醒", "呪い", "分身", "憑依", "不老不死", "時間停止", "透明化", "読心術", "未来視", "過去改変", "夢と現実", "死者蘇生", "魔法継承", "血統覚醒", "封印解除", "変身能力", "次元移動"],
    
    "layer1B": ["救助", "復讐", "逃走", "誘拐", "競争", "謎解き", "裏切り", "犠牲", "守護", "探索", "決闘", "追跡", "潜入", "破壊", "創造", "治療", "教育", "説得", "交渉", "建設", "発見", "発明", "改革", "革命", "再生", "覚醒", "継承", "伝承", "成長", "変化"],
    
    "layer2": ["学校", "病院", "宇宙船", "無人島", "探偵事務所", "魔法学校", "未来都市", "田舎町", "古い屋敷", "研究所", "図書館", "美術館", "劇場", "遊園地", "森", "山", "海", "砂漠", "氷河", "洞窟", "地下都市", "空中都市", "異世界", "仮想現実", "夢の中", "過去", "未来", "平行世界", "魔王城", "天界", "地獄", "精神世界", "記憶の中", "書物の中", "絵画の中", "ゲームの中", "映画の中", "サイバー空間", "宇宙ステーション"],
    
    "layer3": ["双子", "師弟関係", "三角関係", "幼馴染", "手紙", "日記", "猫", "約束", "秘密", "時計", "指輪", "剣", "本", "鏡", "写真", "音楽", "絵画", "花", "星", "月", "雨", "雪", "風", "雷", "光", "影", "扉", "鍵", "地図", "宝石", "羽根", "翼", "角", "尻尾", "マント", "帽子", "仮面", "タトゥー", "傷跡", "記憶の欠片", "魔法の杖", "クリスタル", "オルゴール", "懐中時計", "ペンダント", "ブレスレット", "イヤリング", "香水", "薬", "毒", "解毒剤", "魔法の薬", "愛の薬", "記憶の薬", "変身の薬", "透明の薬", "力の薬", "治癒の薬"]
}
